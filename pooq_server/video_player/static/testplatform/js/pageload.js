...
var contentdatainfoURL = "https://apis.pooq.co.kr/vod/contents/"+contentId+"?apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone="+pooqzone+"&drm="+drm;
...
request.onreadystatechange = function() {
	if(request.readyState == 4 && request.status == 200)
	{
		...
		infobar.innerHTML=
		`<h2>
			<img src = "https://`+programcircleimage+`" alt>`+programtitle+`
		</h2>
...
//------------------------------------------------------------------------------------------------------------------------
		...
		var relatedContentURL = "https://apis.pooq.co.kr/uiservice/recommend/contents/related/"+contentId+"?offset=0&limit=20&apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone="+pooqzone+"&drm="+drm;
...
//------------------------------------------------------------------------------------------------------------------------
		...
		var recommendURL = "https://apis.pooq.co.kr/recommendation/vod/"+contentId+"?apikey="+apikey+"&device=pc&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone="+pooqzone+"&drm="+drm;
...
//------------------------------------------------------------------------------------------------------------------------
		var mostwithURL = "https://apis.pooq.co.kr/uiservice/recommend/contents/mostwith/"+contentId+"?contenttype=vod&offset=0&limit=20&apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone="+pooqzone+"&drm="+drm;
		...
		mostwithRequest.onreadystatechange = function(){
			if(mostwithRequest.readyState == 4 && mostwithRequest.status==200){
				...
				for(var i = 1; i <= bottom_list.length; i++)
				{
					...
					`<a href = "https://pooq.co.kr/player/vod.html?`+bottom_link+`">
						<div class = "thumb-image">
							<img src = "https://`+bottom_img+`" alt class="thumb-img">
							<div>
...
//------------------------------------------------------------------------------------------------------------------------
		...
		var bygenreURL = "https://apis.pooq.co.kr/uiservice/recommend/programs/bygenre/02?contenttype=program&contentid="+contentId+"&offset=0&limit=20&apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone=none&drm="+drm;
...
//------------------------------------------------------------------------------------------------------------------------
		...
		var actorscontentURL = "https://apis.pooq.co.kr/uiservice/recommend/contents/byactor?actor="+encodeURI(actorName)+"&contenttype=program&contentid="+contentId+"&offset=0&limit=20&apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone=none&drm="+drm;
		...
		actor0ContentRequest.onreadystatechange = function() 
		{
			...
			if(actor0ContentRequest.readyState == 4 && actor0ContentRequest.status == 200)
			{
				...
				for(var j = 0 ; j < 3; j++)
				{
					...
					`<a href = 'https://pooq.co.kr/player/vod.html?`+bottom_link+`'>
						<div class = "vod-img">
							<img src = "https://`+bottom_img+`" alt class= 'thumb'>
						</div>
		...
		actorscontentURL = "https://apis.pooq.co.kr/uiservice/recommend/contents/byactor?actor="+encodeURI(actor1Name)+"&contenttype=program&contentid="+contentId+"&offset=0&limit=20&apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone=none&drm="+drm;
		...
		var contentsInfoURL = "https://apis.pooq.co.kr/vod/programs-contents/"+programId+"?apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone="+pooqzone+"&drm="+drm+"&offset=0&limit=10&orderby=new"
				...
				for(var i= 0 ; i < contentsList.length; i++)
				{
					...
					<dt>
						<a href = "https://pooq.co.kr/player/vod.html?programid=`+program_id+`&contentid=`+content_id+`">
							<div>
								<img src = "https://`+image+`" alt class="thumb">
							</div>
							<div>
							</div>
						</a>
		...
		contentsInfoURL = "https://apis.pooq.co.kr/vod/contents/"+contentId+"?device="+device+"&partner="+partner+"&pooqzone=none&region="+region+"&drm="+drm+"&targetage=auto&apikey="+apikey+"&credential="+credential;
		...
		secondContentInfoRequest.onreadystatechange = function()
		{
			if(secondContentInfoRequest.readyState==4 && secondContentInfoRequest.status==200)
			{
				...
				video.setAttribute('poster', "https://"+posterPath);
			}
		}
		...
		{
			var cdnRequestURL = "https://apis.pooq.co.kr/streaming?device="+device+"&partner="+partner+"&pooqzone=none&region="+region+"&drm=wm&targetage=auto&apikey="+apikey+"&credential="+credential+"&contentid="+contentId+"&contenttype=vod&action=hls&quality=480p&deviceModelId=Linux&guid=2e0d4d71-59c8-11e9-909b-c230188c31d3&lastplayid=994c44861e1547268b8313e0ccc8358d&authtype=cookie&isabr=y&ishevc=n"
...
var clipVideoInfoURL = "https://apis.pooq.co.kr/clip/contents?apikey="+apikey+"&device="+device+"&partner="+partner+"&region="+region+"&targetage="+targetage+"&credential="+credential+"&pooqzone="+pooqzone+"&drm="+drm+"&channel=all&programid="+programId+"&contentid="+contentId+"&genre=all&touchtv=all&offset=0&limit=20&orderby=new&smrtype=pooq"
...
clipDataRequest.onreadystatechange = function()
{
	if(clipDataRequest.readyState == 4 && clipDataRequest.status == 200)
	{
		...
		for(var i = 1 ; i <= clipVideoInfoList.length; i++)
		{
